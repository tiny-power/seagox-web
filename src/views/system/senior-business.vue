    ...
    <div>
        ...
        >
            ...
            >
                ...
                <div class="table">
                    <!--列表-->
                    <el-table :data="tableData" @row-dblclick="cellDBClick" max-height="360" border>
...
export default {
    ...
    methods: {
        ...
        showDialog(field, attribute, parameter) {
            this.field = field
        ...
        cellDBClick(row, column, cell, event) {
            this.$emit('confirm', this.field, row, this.attribute)

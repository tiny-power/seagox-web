<template>
    <div class="flow">
        <div :style="{ height: height - 310 + 'px' }">
            <div
                v-for="item in nodes"
                :class="item.type"
                :key="item.id"
            ...
            >
                ...
                >
                    ...
                    <div v-if="item.type === 'parallelGateWay'">
                        <i class="el-icon-plus" style="font-weight: bold; color: #77c67c" v-if="item.status == 1"></i>
                        <i class="el-icon-plus" style="font-weight: bold" v-else></i>
                    </div>
                    <div v-if="item.type === 'exclusiveGateway'">
                        <i class="el-icon-close" style="font-weight: bold; color: #77c67c" v-if="item.status == 1"></i>
                        <i class="el-icon-close" style="font-weight: bold" v-else></i>
                    </div>
                    <div v-if="item.type === 'manualTask'">
                        <i class="el-icon-rank" style="font-weight: bold; color: #77c67c" v-if="item.status == 1"></i>
                        <i class="el-icon-rank" style="font-weight: bold" v-else></i>
                    </div>
                </div>
                <div v-else>
                    <div>

            ...
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <el-form-item label="预算金额" prop="budgetAmount">
                        <el-input-number v-model="form.budgetAmount" :min="0.01" :precision="2" :controls="false" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                ...
                <el-col :span="8">
                    <el-form-item label="保修月份" prop="warrantyMonths">
                        <el-input-number v-model="form.warrantyMonths" :min="1" :precision="0" :controls="false" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="20"
